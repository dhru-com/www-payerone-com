    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-10 rounded-2xl bg-card border shadow-sm group hover:shadow-xl transition-all duration-500">
                <div className="flex items-center justify-between mb-8">
                  ...
                  <span className="text-4xl font-black text-zinc-100 dark:text-zinc-800 group-hover:text-primary/10 transition-colors">{item.step}</span>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-12">
              <div className="p-8 rounded-2xl border bg-white dark:bg-zinc-900 shadow-lg relative overflow-hidden group">
                ...
                <div className="p-4 rounded-xl bg-muted/50 dark:bg-zinc-800/50 font-mono text-xs">
            ...
            <div className="lg:pl-10 flex flex-col items-center text-center lg:items-start lg:text-left mx-auto lg:mx-0">
      ...
      <section className="py-24 bg-muted/30 border-y overflow-hidden">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-8 rounded-2xl bg-white dark:bg-zinc-900 border border-primary/20 dark:border-primary/10 shadow-xl shadow-primary/5">
